...
<head>
    <title>Code coverage report for lib/helpers/finalizeSpecificationObject.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/helpers</a> finalizeSpecificationObject.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const parser = require('swagger-parser');
...
&nbsp;
  parser.parse(swaggerObject, <span class="fstat-no" title="function not covered" >(e</span>rr, api) =&gt; {
