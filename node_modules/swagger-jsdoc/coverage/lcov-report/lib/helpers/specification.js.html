...
<head>
    <title>Code coverage report for lib/helpers/specification.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/helpers</a> specification.js</h1>
        <div class='clearfix'>
 ...
 */
function <span class="fstat-no" title="function not covered" >tagDuplicated(</span>target, tag) {
  // Check input is workable.
<span class="cstat-no" title="statement not covered" >  if (target &amp;&amp; target.length &amp;&amp; tag) {</span>
<span class="cstat-no" title="statement not covered" >    for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; target.length; i += 1) {</span>
      const targetTag = <span class="cstat-no" title="statement not covered" >target[i];</span>
 ...
 */
function <span class="fstat-no" title="function not covered" >attachTags(</span>conf) {
  const { tag, swaggerObject, propertyName } = <span class="cstat-no" title="statement not covered" >conf;</span>
&nbsp;
  // Correct deprecated property.
<span class="cstat-no" title="statement not covered" >  if (propertyName === 'tag') {</span>
<span class="cstat-no" title="statement not covered" >    conf.propertyName = 'tags';</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(tag)) {</span>
<span class="cstat-no" title="statement not covered" >    for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; tag.length; i += 1) {</span>
<span class="cstat-no" title="statement not covered" >      if (!tagDuplicated(swaggerObject[propertyName], tag[i])) {</span>
<span class="cstat-no" title="statement not covered" >        swaggerObject[propertyName].push(tag[i]);</span>
      }
    }
  } else <span class="cstat-no" title="statement not covered" >if (!tagDuplicated(swaggerObject[propertyName], tag)) {</span>
...
&nbsp;
  ...
  if (simpleProperties.indexOf(propertyName) !== -1) {
    ...
    // Tags.
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (propertyName === 'tag' || propertyName === 'tags') {
    const tag = <span class="cstat-no" title="statement not covered" >pathObject[propertyName];</span>
<span class="cstat-no" title="statement not covered" >    attachTags({</span>
      tag,
      swaggerObject,
      propertyName,
    });
