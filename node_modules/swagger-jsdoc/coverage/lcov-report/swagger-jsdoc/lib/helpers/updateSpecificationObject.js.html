...
<head>
    <title>Code coverage report for swagger-jsdoc/lib/helpers/updateSpecificationObject.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">swagger-jsdoc/lib/helpers</a> updateSpecificationObject.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const specHelper = require('./specification');
