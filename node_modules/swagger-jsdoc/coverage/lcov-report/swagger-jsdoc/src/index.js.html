...
<head>
    <title>Code coverage report for swagger-jsdoc/src/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">swagger-jsdoc/src</a> index.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { YAMLException } = require('js-yaml');
&nbsp;
const {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (err instanceof YAMLException) {
