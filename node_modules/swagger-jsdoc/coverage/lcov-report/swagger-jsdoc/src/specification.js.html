...
<head>
    <title>Code coverage report for swagger-jsdoc/src/specification.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">swagger-jsdoc/src</a> specification.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (specification.swagger) {
<span class="cstat-no" title="statement not covered" >    specification.swagger = specification.swagger;</span>
<span class="cstat-no" title="statement not covered" >    v2.forEach(<span class="fstat-no" title="function not covered" >(p</span>roperty) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      specification[property] = specification[property] || {};</span>
    });
  } else {
...
&nbsp;
  toClean.forEach((unnecessaryProp) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hasEmptyProperty(improvedSpec[unnecessaryProp])) {
...
function tagDuplicated(target, tag) {
  ...
  if (target &amp;&amp; target.length &amp;&amp; tag) {
    for (let i = 0; i &lt; target.length; i += 1) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (targetTag.name === tag.name) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (propertyName === 'tag') {
<span class="cstat-no" title="statement not covered" >    conf.propertyName = 'tags';</span>
  }
&nbsp;
  if (Array.isArray(tag)) {
    for (let i = 0; i &lt; tag.length; i += 1) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!tagDuplicated(swaggerObject[propertyName], tag[i])) {
        swaggerObject[propertyName].push(tag[i]);
      }
    }
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (!tagDuplicated(swaggerObject[propertyName], tag)) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Oct 27 2020 14:00:16 GMT+0100 (Central European Standard Time)
            </div>
        </div>
