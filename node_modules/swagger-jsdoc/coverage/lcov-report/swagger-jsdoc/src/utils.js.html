...
<head>
    <title>Code coverage report for swagger-jsdoc/src/utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">swagger-jsdoc/src</a> utils.js</h1>
        <div class='clearfix'>
...
<a name='L120'></a><a href='#L120'>120</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
&nbsp;
  for (let i = 0; i &lt; jsDocComments.length; i += 1) {
    ...
    for (let j = 0; j &lt; jsDocComment.tags.length; j += 1) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (tag.title === 'swagger' || tag.title === 'openapi') {
...
&nbsp;
    case '.coffee':
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (regexResults) {
